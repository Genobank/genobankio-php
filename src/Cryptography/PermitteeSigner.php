...
namespace GenoBankio\Certificates\Cryptography;

/**
 * This performs cryptographic signing on behalf of the permittee
 * @package GenoBankio\Certificates\Cryptography
 */
class PermitteeSigner {
